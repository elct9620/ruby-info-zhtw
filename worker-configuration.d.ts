/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 19b5af2618869517cbcfb932d367631a)
// Runtime types generated with workerd@1.20260131.0 2025-04-29 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IssueDebounceObject";
	}
	interface Env {
		"core@ruby.aotoki.cloud": SendEmail;
		DEBOUNCE_DELAY: "300";
		...
		WEBHOOK_FORWARD_URLS: string;
		ISSUE_DEBOUNCE: DurableObjectNamespace<import("./src/index").IssueDebounceObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEBOUNCE_DELAY" | "CF_AI_GATEWAY" | "OPENAI_API_KEY" | "DISCORD_WEBHOOK" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "SECRET_KEY_BASE" | "ADMIN_EMAIL" | "DISCORD_ALLOW_GUILD_ID" | "DISCORD_ALLOW_ROLE_ID" | "LANGFUSE_SECRET_KEY" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_BASE_URL" | "WEBHOOK_FORWARD_URLS">> {}
}
declare module "*.md" {
	const value: string;
