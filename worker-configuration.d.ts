/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e1a2e9f3f44e2c73baff9d42bd22510d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEBOUNCE_DELAY" | "CF_AI_GATEWAY" | "OPENAI_API_KEY" | "DISCORD_WEBHOOK" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "SECRET_KEY_BASE" | "ADMIN_EMAIL" | "DISCORD_ALLOW_GUILD_ID" | "DISCORD_ALLOW_ROLE_ID" | "LANGFUSE_SECRET_KEY" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_BASE_URL">> {}
}
declare module "*.md" {
	const value: string;
