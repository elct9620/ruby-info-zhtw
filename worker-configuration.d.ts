/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3a1d9d8593f6a7a54c67b3759c94387a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_AI_GATEWAY" | "OPENAI_API_KEY" | "DISCORD_WEBHOOK" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "ADMIN_EMAIL">> {}
}
declare module "*.md" {
	const value: string;
