/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8fdb5055a3c42cdbb2336210a671cee9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_AI_GATEWAY" | "OPENAI_API_KEY" | "DISCORD_WEBHOOK" | "ADMIN_EMAIL">> {}
}
declare module "*.md" {
	const value: string;
